                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text("name: "+listCars[index].name.toString(),
                                style: TextStyle(
                                  color: cardTextColor,
                                  fontSize: 22,
                              ...
                              SizedBox(height: 20,),
                              Text("  price: "+listCars[index].price.toString(),
                                style: TextStyle(
                                    color: cardTextColor,
                                    fontSize: 22,
                                    fontWeight: FontWeight.bold,
                          ...
                          Image.asset("assets/images/"+listCars[index].nameImage.toString(),width: 150,height: 160,),
                        ],
                      ),
                    ),
                  );
